...
$temp='Temperature based on your current location: '.$weather->temperature;
$c2= 'degree';

//return view('weather.dashboard')->with('temp', $temp);
//return view('weather.dashboard')->with('temp', $temp);  //ogg
return View::make('weather.dashboard')->with(['c1' =>$temp, 'c2' => $c2]); 
